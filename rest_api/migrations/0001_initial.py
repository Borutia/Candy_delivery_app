    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders_id', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveIntegerField(), size=None, verbose_name='id текущих заказов')),
                ('last_complete_time', models.DateTimeField(verbose_name='Время последней доставки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assign_time', models.DateTimeField(verbose_name='Время назначения')),
                ('complete_time', models.DateTimeField(verbose_name='Время выполнения')),
                ('delivery_time', models.TimeField(verbose_name='Время доставки в секундах')),
                ('courier_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rest_api.courier')),
            ],
        ),
    ]
