    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courier_type_in_delivery', models.CharField(choices=[('foot', 'Пеший курьер'), ('bike', 'Велокурьер'), ('car', 'Курьер на автомобиле')], max_length=4, null=True, verbose_name='Тип курьера на момент формирования развоза')),
