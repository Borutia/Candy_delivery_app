...
class Order(models.Model):
    ...
    delivery_hours = ArrayField(models.CharField(max_length=11), verbose_name='Промежутки для доставки')
    status_order = models.CharField('Статус заказа', max_length=1, choices=StatusOrder.choices,
